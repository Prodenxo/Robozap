export const botTexts = {
  ...
  media: {
    ...
    musicaErrorYoutubeApi: "📛 *YouTube bloqueou o servidor.* No Easypanel, suba o app *yt-session* (imagem ghcr.io/imputnet/yt-session-generator:webserver) e no cobalt adicione YOUTUBE_SESSION_SERVER=http://yt-session:8080/ — depois redeploy dos dois.",
