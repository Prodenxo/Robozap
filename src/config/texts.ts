export const botTexts = {
  ...
  media: {
    ...
    musicaErrorGeneric: "💀 *ERRO NO SOM.* Tentei Cobalt e fallbacks e não rolou. Tenta outra música ou o link direto do YouTube.",
    musicaErrorYoutubeLogin: "🔐 *YouTube pediu login nesse servidor.* Tenta outra música — o bot não depende de cookie manual.",
    musicaErrorYoutubeApi: "📛 *Servidores de download sobrecarregados.* Tenta outra música ou o link direto do YouTube.",
    musicaErrorNoSession: "⚠️ *yt-session sem token.* Pode ignorar se o Cobalt público estiver ok; senão aumenta a RAM do yt-session.",
