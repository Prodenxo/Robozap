export const botTexts = {
  ...
  media: {
    ...
    musicaErrorGeneric: "💀 *ERRO NO SOM.* Tentei vários caminhos e não rolou. Se o proxy tá com erro 407, troca o proxy ou remove HTTP_PROXY e usa só os cookies.",
    musicaErrorYoutubeLogin: '🔐 *YouTube bloqueou.* Confere se YOUTUBE_COOKIES ainda é válido (renova no navegador). Proxy com 407 também derruba o download.',
