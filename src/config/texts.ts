export const botTexts = {
  ...
  media: {
    ...
    musicaErrorYoutubeLogin: "🔐 *YouTube pediu login.* No Easypanel, app *cobalt*: monte um cookies.json do YouTube e configure COOKIE_PATH=/cookies.json. Depois redeploy do cobalt.",
