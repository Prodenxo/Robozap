export const botTexts = {
  ...
  media: {
    ...
    musicaErrorGeneric: "💀 *ERRO NO SOM.* Tentei vários servidores e não rolou. Manda o *link do YouTube* ou tenta de novo em 1 min.",
    musicaErrorYoutubeLogin: '🔐 *YouTube tá bloqueando downloads agora.* Tenta de novo em 1–2 min, ou manda o *link direto* do YouTube. Se persistir: sobe o *yt-session* com mais RAM no Easypanel.',
    musicaErrorYoutubeApi: "📛 *Servidores de download sobrecarregados.* Tenta outra música ou o link direto do YouTube.",
    musicaErrorNoSession: "⚠️ *yt-session sem token.* Aumenta a RAM do yt-session ou remove YOUTUBE_SESSION_SERVER do Cobalt.",
